...
var AppStoresForPicTextMix650x650 = require('./store');
var AppActionsForPicTextMix650x650 = require('./action');
				...
				<div className="list-wrap-w">
					<div className="list-padding2">
						<div className="clickT" onClick={function(){self.tuijianLink(data)}}>
							...
							<Img src={lib.returnImgHost()+data.smallPicUrl} size="650x650" rname="list-img" />
						</div>
						...
						<div className="pricePlaceAndBtn">
							...
							<div className="btnwrap">
								<Button data={data} hotItem={hotItem} serverTime = {serverTime} templateChoose={templateChoose} whichBtn={whichBtn} activityId_activityType={activityId_activityType} callback={function(params){setTimeout(function(){AppActionsForPicTextMix650x650.setPicTextListData650x650(params)},1)}}/>
							</div>
						</div>
					</div>
				</div>
...
var PicTextMix650x650 = React.createClass({	
    ...
    componentDidMount: function() {
        ...
        AppStoresForPicTextMix650x650.addChangeListener(this._onChange);
    ...
    componentWillUnmount: function() {
        AppStoresForPicTextMix650x650.removeChangeListener(this._onChange);
    },
    _onChange: function() {
    	var activityId_activityType = this.state.activityId_activityType;
    	var activityId_activityType_Store = AppStoresForPicTextMix650x650.data.activityId_activityType;
    	if(activityId_activityType == activityId_activityType_Store) {
        	this.setState(AppStoresForPicTextMix650x650.data);
    	}
    },
	...
	render: function() {
		...
		if(!hotItem || hotItem.length==0) {
			return (
				<div className="PicTextMix" id={moduleId} style={{display:'none'}}>
		...
		return (
			<div className="PicTextMix" id={moduleId} style={strHidden}>
				<div className={getRightClassName} id={moduleId+'maodian'}></div>
				<div className="PicTextMixWrap">
					{PicTextMixListWrap}
				</div>
...
window.AppActionsForPicTextMix650x650 = AppActionsForPicTextMix650x650;
module.exports = PicTextMix650x650;
