...
var AppStoresForTuijianFood = assign({}, EventEmitter.prototype, {
...
AppDispatcher.register(function(payload) {
  ...
  switch(action.actionType) {
    case "setTuijianListData":
      return setTuijianListData(action.params);
    default:
      return true;
  }
});

function setTuijianListData(params) {
    ...
    AppStoresForTuijianFood.data = params;
    AppStoresForTuijianFood.emitChange();
}


AppStoresForTuijianFood.initData = {
    requestOver:false,
    error:{
...
module.exports = AppStoresForTuijianFood;
